...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Créer un paiement Stripe avec le token Apple Pay
    try {
    ...
    return res.status(500).json({
      error: error.message || 'Failed to process Apple Pay'
    });
  }
};
